...
Пример итоговой строки: "Результат битвы: Победа команды Волшебники данных!"
...
print('Волшебники данных решили задачи за {0} c'.format(round(team2_time, +1)))
#Использование f-строк:
print(f'Команды решили {score_1} и {score_2} задач.')
print(f'Результат битвы: {challenge_result}')
print(f'Сегодня было решено {score_1 + score_2} задач, в среднем по {round((team1_time + team2_time)/82, +1)} секунды на задачу!.')