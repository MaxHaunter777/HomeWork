...
class Knight(Thread):
    ...
    def __init__(self, name_kn, power):
    ...
    def run(self):
        ...
        print(f'{self.name_kn}, на нас напали!')
        while enemy != 0:
            enemy = enemy - self.power
            count_day += 1
            print(f'{self.name_kn}, сражается {count_day} день(дня)..., осталось {enemy} воинов.\n')
            sleep(1)
        print(f'{self.name_kn} одержал победу спустя {count_day} дней(дня)!')
